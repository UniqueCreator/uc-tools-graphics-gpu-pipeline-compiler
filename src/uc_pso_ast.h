    ...
    namespace pso
    {
        namespace ast
        {
            ...
            struct DXGI_FORMAT_
            {
                ...
                DXGI_FORMAT_() {}
                DXGI_FORMAT_(DXGI_FORMAT v) : m_v(v) {}

                DXGI_FORMAT operator()() const
                {
                    return m_v;
                }
            ...
            */
            ...
            template <typename t> struct simple_strong_type
            {
                simple_strong_type() {}
                simple_strong_type(t v) : m_v(v) {}
            ...
            using DXGI_FORMAT_                          = simple_strong_type<DXGI_FORMAT>;
            using D3D12_PRIMITIVE_TOPOLOGY_TYPE_        = simple_strong_type<D3D12_PRIMITIVE_TOPOLOGY_TYPE>;
            using D3D12_INDEX_BUFFER_STRIP_CUT_VALUE_   = simple_strong_type<D3D12_INDEX_BUFFER_STRIP_CUT_VALUE>;
            using uint32_t_                             = simple_strong_type<uint32_t>;
